...
<section class="home-banner">
  ...
  <div class="carousel-item banner-slide"
                style="background-image:url('./assets/images/new-images/home-banner-4.webp'); background-size:cover; background-repeat: no-repeat">
                ...
                <div class="ms-lg-5">
                    <div class="img-box">
                        ...
                        <div class="about-coun-box">
                            <span class="coun-number">10</span>
        ...
        <div class="row gy-4 gy-lg-0 gx-0">
            <div class="col-lg-6 col-md-9">
                <div class="p-lg-5">
                    ...
                    <p class="why-choose-text">In today’s fast-evolving manufacturing landscape, choosing the right automation partner makes all the difference. PVM Automation stands out as a trusted and innovative solution provider, delivering precision-driven systems tailored to modern industrial needs. Here’s why PVM Automation is the preferred choice:</p>
        ...
        <div class="row gy-4 justify-content-evenly">
            ...
            <div class="col-lg-2 col-6 col-md-4">
                <div class="box-wrapper year-box">
                    ...
                    <h5 class="box-title count" data-count="10">10 <span>+</span></h5>
                </div>
            </div>
        </div>
